...
const SITE_URL = process.env.NEXT_PUBLIC_SITE_URL ?? "https://shian-studio.vercel.app";
const OG_IMAGE = `${SITE_URL}/portfolio/shian-studio.jpg`;
...
export default async function RootLayout({
  ...
  // Read the nonce generated by middleware for CSP-compliant inline scripts
